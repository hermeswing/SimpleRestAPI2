...
public class JwtSecurityConfig {
    ...
    public JwtSecurityConfig(JwtTokenProvider tokenProvider, JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint, JwtAccessDeniedHandler jwtAccessDeniedHandler ) {
        log.debug( "★★★★★★★★★★★★★★★★★★ [JwtSecurityConfig] 생성자 생성. ★★★★★★★★★★★★★★★★★" );
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        log.debug( "★★★★★★★★★★★★★★★★★★ [JwtSecurityConfig.webSecurityCustomizer] ★★★★★★★★★★★★★★★★★" );
    ...
    public SecurityFilterChain securityFilterChain( HttpSecurity http ) throws Exception {
        log.debug( "★★★★★★★★★★★★★★★★★★ [JwtSecurityConfig.securityFilterChain] ★★★★★★★★★★★★★★★★★" );
